...
ENV TFDOCS_VERSION v0.12.1
ENV TFLINT_VERSION v0.24.1
ENV TFSEC_VERSION v0.39.5

COPY requirements.txt /

RUN apk add --update --no-cache perl=5.30.3-r0 python3=3.8.8-r0 bash=5.0.17-r0 git=2.26.3-r0 musl=1.1.24-r10 gawk=5.1.0-r0 curl=7.69.1-r3 unzip=6.0-r8 && \
